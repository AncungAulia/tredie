     ...
     privacy policy
      ...
      <div className='relative w-full h-[27%] bg-[#1E1E1E] overflow-hidden'>
        ...
        <svg preserveAspectRatio="none" width="100%" height="100%" viewBox="0 0 1856 266" className="absolute inset-0 object-contain w-full h-full">
          <text x="928" y="230" textAnchor="middle" fontFamily="Arial, Helvetica, sans-serif" fontSize="248" fontWeight="800" fill="#1E1E1E" letterSpacing="120">TREDIE</text>
        </svg>
        ...
        <g mask="url(#cursorMask)">
          <text x="928" y="230" textAnchor="middle" fontFamily="Arial, Helvetica, sans-serif" fontSize="248" fontWeight="800" fill="#E0FF98" letterSpacing="120">TREDIE</text>
          </g>
        </svg>
      </div>
